...
def find_answer(user_message):
    ...
    knowledge_base = {
        ...
        "дополнительные вопросы": "Если у вас есть дополнительные вопросы, не стесняйтесь связаться с нашим менеджером!",
        "оплата": "наличными или по покарте курьеру или оператору на складе."
        "помощь": "Как я могу помочь вам сегодня?"
    }
    ...
    # Поиск ответа по ключевым словам с более гибким подходом
    for keyword, answer in knowledge_base.items():
        if keyword in user_message:
            return answer
    
    # Фallback ответ
    return "Извините, я не могу помочь с этим вопросом. Пожалуйста, уточните ваш запрос на следующие темы:
        "оригинал": "возврат":  "предоплата":  "доставк ."
...
📞 Контактный телефон: +7 (495) 999-99-99
